document.addEventListener("DOMContentLoaded", () => {
  ...
  //solution without second APi call
  options.addEventListener("change", (e) => {
    title.textContent = allMovies[options.selectedIndex - 1].title;
    year.textContent = allMovies[options.selectedIndex - 1].release_date;
    description.textContent = allMovies[options.selectedIndex - 1].description;
  });
